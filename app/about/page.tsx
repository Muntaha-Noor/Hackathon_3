    ...
    <div className="px-4 md:px-[150px] mx-auto mt-6">
      <section className="flex flex-col md:flex-row items-center gap-8 mb-16">
        <div className="bg-primary w-full md:w-[700px] h-[500px] p-8 md:p-20 flex flex-col justify-between">
          ...
          <button className="mt-6 md:mt-36 px-4 w-36 py-2 bg-teal-600 text-white rounded">
            View Collection
          </button>
        </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {[
            ...
            <div
              key={index}
              className="p-4 shadow-sm text-left bg-white rounded-md"
            >
              <Image
                src={product.img}
                alt={product.name}
